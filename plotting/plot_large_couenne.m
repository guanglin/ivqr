...
print(fig,'-dpsc','compare_large_couenne.ps');  
!ps2pdf compare_large_couenne.ps
!pdfcrop compare_large_couenne.pdf
!mv compare_large_couenne-crop.pdf compare_large_couenne.pdf
% 
