...
diary('../../results/log_couenne_small.txt');
...
for i = 1 : lgth
  ...
  strAmplSystemCall = sprintf('ulimit -t 901; ampl invlp.run');
  tic;
  ...
  save('../../results/result_couenne_small.mat', 'obj_q', 'sol_q', 'ind_q', 'time_q',  'obj_c', 'sol_c', 'ind_c', 'time_c');
