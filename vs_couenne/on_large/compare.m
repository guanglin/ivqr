...
diary('../../results/log_couenne_large.txt');
...
for i = 1 : lgth
  ...
  diary on
  i
  fprintf('Now comparing on large_IVQR instance %d\n\n', i );
  ...
  strAmplSystemCall = sprintf('ulimit -t 7201; ampl invlp.run');
  tic;
  ...
  save('../../results/result_couenne_large.mat', 'obj_q', 'sol_q', 'ind_q', 'time_q',  'obj_c', 'sol_c', 'ind_c', 'time_c');
