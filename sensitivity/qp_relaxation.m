function [ fval , x, ret, node ] = qp_relaxation( A1, A2, b, big_M, time_limit )
...
while ~(isempty(LBLB)&&isempty(LBLB1))
   ...
   if mod(iter,5000) == -1
    ...
    if ~isempty(LBLB)
        LBLB = LBLB(1:end-1);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%         if ~isempty(StartStart)
%             StartStart = StartStart(1:end-1);
%         end
